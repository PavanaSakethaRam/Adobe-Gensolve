...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "pt-20 relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex xl:-translate-y-[17rem] -translate-y-[30rem] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
